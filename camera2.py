...
def main():
    ...
    model_path = "runs/detect/cable_detector15/weights/best.pt"  # Ajusta la ruta si es necesario
    try:
    ...
    while True:
        ...
        try:
            results = model.predict(frame, conf=0.5)  # Ajusta el umbral de confianza si es necesario
